...
## How to File: e-Tax (Online) *(Recommended)*

**Requirements:**
- My Number Card + NFC-capable phone, or
- ID/password issued at the tax office
...
**Where:** Nagaoka Tax Office (長岡税務署) or a temporary filing counter set up near IUJ/city hall during filing season

**What to bring:**
- Withholding tax slip(s) (源泉徴収票) from employer
- My Number Card or notification letter + Residence Card
- JP Bank account details for refund
- National Health Insurance premium payment records (deductible)
...
## Year-End Adjustment (年末調整) vs Tax Return

- If you work for a single employer, they handle year-end tax adjustment (年末調整) in November/December
- This means your taxes are settled and **you don't need to file**
- If you change jobs, have multiple jobs, or have other income sources, you file your own return
...
|---|---|---|
| 確定申告 | Kakutei shinkoku | Annual tax return |
| 源泉徴収票 | Gensen chōshū-hyō | Withholding tax certificate |
| 還付 | Kanpu | Tax refund |
| 所得税 | Shotokuzei | Income tax |
| 控除 | Kōjo | Tax deduction |
...
- Scholarship-specific tax status for MEXT / JASSO / private scholarships
