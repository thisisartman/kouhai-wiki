...
**Best for:** Supplements, protein powder, specialty health foods, Western/vegan products, skincare.

iHerb ships directly from the US to Japan, usually in 5–10 days. Pricing in USD often beats Amazon JP significantly for supplements. No membership required.

- Website: [iherb.com](https://www.iherb.com)
- Ships reliably to Japanese addresses
- Use a Wise card or international credit card

> 💡 Popular items: protein powder, nutritional yeast, vegan cheese, whey, multivitamins, sunscreen, specific skincare brands.
...
- Useful for: specialty Japanese food, tatami/traditional items, sports equipment
...
- Affordable formal wear for presentations
- Seasonal items you'll only need once (ski layering, rain gear)

> ⚠️ Quality varies significantly between items. Read reviews and check photos carefully. Returns are possible but require shipping back to China.
...
**Caution:** Delivery times can be unpredictable (7–21 days). Not reliable for time-sensitive purchases.
...
**Create an account at [mercari.com/jp](https://jp.mercari.com)**
...
| Method | Works On |
|---|---|
| Visa/Mastercard (international) | All platforms |
| Wise card | All platforms |
| PayPay | Amazon JP, Mercari, many Japanese sites |
| Konbini payment (cash at conbini) | Amazon JP, Mercari, many JP sites |

> 💡 Konbini payment is useful if you don't yet have a Japanese card or want to use cash. Pay at the convenience store counter within a set window after ordering.
...
- Shein/Temu sizing advice for specific body types
- Any other online platforms worth using in Japan
