...
Your IUJ dormitory address is your official mailing address in Japan. You need it in Japanese (日本語) for most services. Get the exact format from your IUJ welcome packet or admissions letter.

**Format:**
```
〒949-7277
新潟県南魚沼市大崎1番地
国際大学 [Building/Room if applicable]
[Your Name in English or Katakana]
```

> 💡 Save your address in Japanese on your phone from day one. You'll need it for online shopping, bank setup, and city registration.

---

## Receiving Packages

Japan's main couriers are **Yamato Transport (ヤマト運輸)** and **Sagawa Express (佐川急便)**. Japan Post (郵便局) handles mail and some parcels.

### If You Miss a Delivery

A redelivery slip (不在票, *fuzai-hyō*) is left at your door or mailbox. It includes:
- The courier company
- A tracking number / redelivery code
...
Amazon JP and some other retailers let you redirect packages to a nearby 7-Eleven, Lawson, or FamilyMart. You pick up at your convenience within 3–7 days. Useful if your schedule is unpredictable.

---

## Sending Mail Domestically

Go to the **Post Office (郵便局)**, or drop in a red mailbox (ポスト) on the street for small letters.
...
|---|---|---|
| EMS (国際速達) | 3–6 days | ~¥3,000–4,000 |
| Airmail | 6–14 days | ~¥2,000–3,000 |
| SAL (Surface Air Lifted) | 2–4 weeks | ~¥1,500–2,000 |
...
- Check for your packages regularly, especially during high-order periods (post-arrival, start of winter)
- Mark packages clearly with your room number to avoid confusion
...
- Any customs issues with sending/receiving international packages
