...
| Item | Japanese | Notes |
|---|---|---|
| Steamed bun | 肉まん (nikuman) | Pork-filled; avoid if no pork. Vegetable versions sometimes available. |
| Fried chicken | からあげ / チキン | Lawson's is particularly famous |
...
## Vegetarian & Dietary Navigation

Japan labels ingredients in Japanese. Key things to check:

| Ingredient | Japanese | Watch for in |
|---|---|---|
| Pork | 豚肉 (ぶたにく) | Buns, bento, seasoning |
| Beef | 牛肉 (ぎゅうにく) | Bento, burgers |
| Chicken | 鶏肉 (とりにく) | Fillings, soup base |
| Fish | 魚 (さかな) / 魚介 | Dashi stock, oden |
| Egg | 卵 (たまご) | Most sandwiches, some onigiri |

> 💡 Google Translate camera mode on the ingredient list is fast and reliable enough for daily use.
...
## Conbini as a Meal Strategy

Using conbini as your primary food source is expensive over time (¥600–900/day adds up). But as a supplement to cooking:
- Breakfast: onigiri + hot drink = ¥250
- Late-night study snack: cup noodle + discounted bento = ¥400
- Emergency dinner when you forgot to shop: ¥600–700 bento

> 💡 Budget students who cook most meals and use conbini for breakfast and snacks spend around ¥20,000–30,000/month on food in rural Niigata.
...
- Seasonal items worth watching for (Christmas cake, summer cold noodles, etc.)
- Best conbini for specific needs (ATM, printing, food quality)
