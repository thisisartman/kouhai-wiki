...
- Southeast Asia fares are frequently on sale, so subscribe to Skyscanner alerts
...
- A classic Japan loop (Tokyo → Kyoto → Osaka → Hiroshima → back) justifies a 7-day pass on its own
