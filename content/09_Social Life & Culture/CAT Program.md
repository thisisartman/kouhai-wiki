...
**Compensation and recognition:** Each CAT visit comes with a **¥1,000 VJA gift card** (a paper gift certificate usable at many Japanese stores/restaurants). Students who complete **five or more visits in an academic year** become eligible for a **Certificate of Appreciation issued by the Superintendent of the Minamiuonuma City Board of Education** — a genuinely useful line for a CV/resume given it's a real municipal-government-issued document, not just an IUJ one. Graduating students who haven't done any CAT visits yet can still get a simpler IUJ-issued certificate for a single visit before they leave.
...
CAT isn't the only way IUJ students get pulled into (mostly paid or small-stipend) local community/education work — it's part of a genuine recurring pattern, not a one-off. Confirmed examples IUJ has run:
...
The `13_Country-Specific/` section of this wiki includes country profiles that were originally conceived as CAT resources — background info on each represented nationality. In practice, they're useful for anyone wanting to understand their IUJ classmates' contexts.
