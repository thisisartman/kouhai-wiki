...
## Japan Daily Life Apps

### Mercari (メルカリ)
Japan's major second-hand marketplace. Buy and sell used items. See [[Online Shopping — Amazon JP, Shein, Temu]].

### Amazon Japan
Most students already know this. The app is cleaner than the website for quick orders.

### Tabelog (食べログ)
Japan's primary restaurant review platform. More reliable than Google Maps for restaurant ratings in Japan. Japanese interface but Google Translate handles it.
...
Japan government's official disaster prevention app. Push notifications for earthquakes, tsunamis, and severe weather. Download and set up immediately.

### Yahoo! Japan Disaster Prevention (ヤフー防災速報)
Faster earthquake and disaster alerts than most official apps. Japanese interface but straightforward.

See [[Earthquake Preparedness]] for context.
...
- Any apps that seem useful but weren't worth it
