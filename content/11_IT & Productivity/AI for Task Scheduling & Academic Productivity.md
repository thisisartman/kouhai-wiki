...
**AI is good at:**
- Reformatting, restructuring, summarising existing content
- Generating first drafts to react to (not submit)
- Explaining unfamiliar concepts in accessible terms
- Suggesting relevant search terms, frameworks, or literature directions
- Proofreading and language polish
- Scheduling and task management prompts
- Translation assistance (Japanese especially)

**AI is unreliable for:**
- Factual claims requiring accuracy (hallucination is real)
- Up-to-date information (models have knowledge cutoffs)
- Legal, medical, or financial advice that matters
- Producing final academic work without verification

The graduate school context matters: your professors will notice AI-generated writing. The goal is to think better, not to avoid thinking.
...
- Be specific: "Explain the core argument of constructivism in IR theory, as if explaining to someone with an economics background" beats "explain constructivism"
...
Upload PDFs of your readings, lecture notes, or papers. Ask questions about them, request summaries, generate study guides. Genuinely useful for synthesising large reading loads.
...
- Note-taking systems that worked for IUJ's seminar format
