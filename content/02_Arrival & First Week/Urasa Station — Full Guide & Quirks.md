...
- IUJ runs shuttle buses that coincide with Shinkansen arrivals — **check the schedule on the IUJ student portal before you arrive**
- Free for students
- ⚠️ Buses don't run on all trains or at all hours — confirm your arrival train before booking
...
- **West Exit (西口)** — faces the other side of the tracks, less useful for students
- **Ticket gates** — IC card readers are present, but your Shinkansen ticket needs to be inserted/scanned separately from your IC card
- **Escalators & elevators** — available, important on arrival day with heavy bags
...
- ⚠️ Limited number of large lockers — don't count on them on busy days
...
Only **Toki** and **Tanigawa** services stop here.
...
- ⚠️ Late-night trains are sparse — last Shinkansen to Urasa from Tokyo is around 21:00–22:00. Check schedules on [HyperDia](https://www.hyperdia.com) or Google Maps.

---

## Nearby Convenience & Services

- **7-Eleven** — a short walk from the station; useful for snacks, cash (international ATM), and printing
- **Post Office** — short distance; useful for receiving packages
- No restaurants or major shops at the station itself — plan accordingly
