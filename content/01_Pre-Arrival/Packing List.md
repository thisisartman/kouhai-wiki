...
- IUJ acceptance / scholarship letter
- 10+ passport-sized photos (you'll use them for MyNumber, bank accounts, etc.)
...
> ⚠️ Do not assume you'll buy winter gear here in time. Niigata gets serious snowfall from November. Arrive prepared or plan to order online immediately after arrival. See [[Seasons & Weather — Month by Month]].

### Summer / Transition Months
- Light breathable wear for September arrival (it's still warm)
- Rain jacket or packable waterproof layer

### Optional
- Swimwear (Niigata has beach and onsen access)
- Athletic/gym wear (IUJ has a gym)
- Traditional dress if you want to bring cultural outfits for events
...
| Item | Notes |
|---|---|
| Prescription medications | 1–3 months' supply; see [[Visa & Documentation]] for rules |
...
| Item | Notes |
|---|---|
| Small combination lock | Useful for dorm lockers or gym storage |
| Reusable bags | Japan produces a lot of small bags; still useful for groceries |
| Travel pillow | For the long flight and Shinkansen trips |
| Cash (Japanese Yen) | Bring ¥20,000–30,000 cash for immediate needs. Cards aren't accepted everywhere on day 1. |
| International Student ID (ISIC) | Optional; some discounts in Japan |
...
| Item | Why |
|---|---|
| Large collection of books | Heavy; use the IUJ library or e-books |
| Excessive toiletries | Cheap and excellent in Japan |
| Multiple pairs of shoes | Take up luggage; buy basics here |
| Full bedding set | Available at recycle shops for ¥1,000–2,000 total |
| Kitchen appliances | Provided in dorms or available cheaply |
