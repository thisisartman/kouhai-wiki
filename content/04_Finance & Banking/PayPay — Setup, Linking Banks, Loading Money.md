...
- Accepted almost everywhere in Japan, including rural Niigata
- Many small local shops that don't accept foreign credit cards **do** accept PayPay
- Cashback campaigns and discounts are frequent
...
### 1. Download the App
- iOS: App Store → search "PayPay"
- Android: Google Play → search "PayPay"
- The app has an English mode (Settings → Language)

### 2. Create an Account
1. Open PayPay → tap "Sign Up"
...
### Option A: Link JP Bank Account *(Recommended)*
After identity verification:
1. Go to: Payment → Add Bank Account
2. Select "ゆうちょ銀行" (Japan Post Bank)
3. Enter your JP Bank account number and branch code (記号・番号)
4. Authenticate via JP Bank app or web
5. Once linked, you can transfer money from JP Bank to PayPay balance instantly
...
1. Go to: Charge → Convenience Store
2. Select your store (7-Eleven, Lawson, FamilyMart)
3. Show the generated barcode at the register
4. Pay cash → balance loaded instantly
- Minimum load: ¥1,000 | Maximum: ¥50,000 per transaction
...
|---|---|
| Unverified | ¥50,000 |
| Verified (Residence Card) | ¥500,000 |
...
| Problem | Solution |
|---|---|
| Can't verify with Residence Card | Ensure photo is clear, all text readable, no glare |
| Bank linking fails | Confirm JP Bank account is active and you have the 記号番号 (account symbol-number, not just account number) |
| Payment declined | Check balance or card limit; some merchants have minimum amounts |
| App in Japanese | Settings (歯車アイコン) → Language → English |
