...
| Service | Best For | Speed | Fee | Rate |
|---|---|---|---|---|
| **Wise** | Most countries; best rates | 1–2 days | Low, transparent | Near mid-market ✅ |
| **Remitly** | India, Philippines, Africa | Hours–1 day | Varies; promo rates for first transfer | Decent |
| **Western Union** | Cash pickup option | Minutes–1 day | Higher | Less competitive |
| **Japan Post (国際送金)** | If you distrust apps | 3–5 days | Moderate | Moderate |
| **SBI Remit** | India specifically | Same day possible | Low | Good for INR |

---

## Wise *(Recommended for Most Students)*

Wise (formerly TransferWise) consistently offers the best exchange rates with transparent, low fees.
...
- Available at Japan Post offices
- Useful if recipient needs **cash pickup** rather than bank transfer
- Higher fees than Wise/Remitly
...
## Non-Resident Status: A Real Cost Trap in Your First 6 Months
...
## Before You Send: Key Info to Gather

For most services you'll need:
- Recipient's full name (as on bank account)
- Bank name and branch
- Account number / IBAN / IFSC (varies by country)
- SWIFT/BIC code of the recipient bank
- Your JP Bank account details as source
