...
| | JP Bank (ゆうちょ銀行) | Daishi Hokuetsu Bank (第四北越銀行) |
|---|---|---|
...
> ⚠️ Some post offices in rural areas have limited English support. Bring a Japanese-speaking friend if possible for the first visit, or use the IUJ international student support services.
...
Some banks require a personal seal instead of a signature. A basic rubber stamp inkan costs ¥500–1,500 at:
- 100 yen shops (Daiso)
- Stationery stores
- Some convenience stores

For a foreign name, katakana approximation is used (e.g., アルジュン for "Arjun"). Ask a Japanese speaker to help you get this right before you go to the bank.

---

## ATM Access Summary

| Location | JP Bank ATM? | Daishi ATM? |
|---|---|---|
| Japan Post offices | ✅ | ❌ |
| 7-Eleven | ✅ | ✅ |
| Lawson | ✅ (via partner) | ❌ |
| FamilyMart | ✅ (via partner) | ❌ |
| Daishi branches | ❌ | ✅ |

> 💡 7-Eleven ATMs accept most foreign and domestic cards and have an English interface. Most reliable ATM option in rural areas.
