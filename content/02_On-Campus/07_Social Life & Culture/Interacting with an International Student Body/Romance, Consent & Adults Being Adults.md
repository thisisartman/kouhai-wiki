---
title: Romance, Consent & Adults Being Adults
section: 02_On-Campus/07_Social Life & Culture/Interacting with an International Student Body
aliases: ["09_social-life--and--culture/interacting-with-an-international-student-body/romance,-consent--and--adults-being-adults"]
...
A few things shape romantic life here:

**Proximity and intensity.** You spend an enormous amount of time with a small group of people under shared stress. Feelings develop fast. This can be genuine; it can also be partly situational. Both are fine, as long as you're honest with yourself and others about which it is.
...
## Consent: The Actual Standard

Consent is enthusiastic, ongoing, and freely given. This applies regardless of cultural background, relationship history, or how the evening is going.

**Practical points:**
- "I'm not sure" is not yes.
- Intoxication impairs the ability to consent. If someone is drunk, the answer is wait.
- Previous consent doesn't carry forward. Check in.
- Consent to one thing is not consent to everything else.

IUJ's international student population includes people from countries with different legal and cultural frameworks around consent. The standard above is the right one — not the most permissive one from anyone's home country.

---

## Navigating Cross-Cultural Signals
...
- Keep mutual friends out of the middle where possible
- Give each other space, then normalise interactions gradually

---

## Dorm Rules and Social Norms

> ⚠️ Verify IUJ's official policies on overnight guests and dorm conduct against the current student handbook.

IUJ dorm rules govern overnight visitors. Know them — violations can have consequences. Discretion is also just socially useful in a small community.
...
If you witness something concerning, checking in with the person privately is appropriate. You don't need to be certain something wrong happened to ask "are you okay?"
