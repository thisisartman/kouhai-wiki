...
> ⚠️ Verify exact credit requirements against your program's official curriculum guide.
...
| Type | Notes |
|---|---|
| Core/Required | Must take; often have set schedules |
| Electives | Choose based on interest/specialization |
| Cross-listed | Available to both MBA and IR students |
| Japanese Language | Offered at multiple levels; highly recommended |
| Audit | Sit in without credit; confirm if allowed with instructor |
