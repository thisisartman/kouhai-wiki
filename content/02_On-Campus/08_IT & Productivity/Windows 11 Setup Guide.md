...
IUJ's official guide: [Windows 11 Initial Setup (PDF)](https://www2.iuj.ac.jp/mlic-cs/pdf/Win11_Initial%20setup.pdf).
...
![Region/country confirmation screen with Japan selected](images/windows11-setup/region-select.png)

![Network connection screen entering the WiFi security key](images/windows11-setup/network-connect.png)

![Microsoft account password entry — note this is a personal email, not your IUJ address](images/windows11-setup/microsoft-account-password.png)

![PIN setup screen with the option to include letters and symbols](images/windows11-setup/pin-setup.png)

![OneDrive backup screen — "Save files only on this PC" option highlighted](images/windows11-setup/onedrive-backup-choice.png)
...
IUJ's official guide: [Change language from Japanese to English (PDF)](https://www2.iuj.ac.jp/mlic-cs/pdf/Win11_Language_Change.pdf).
...
![Right-click Start menu with Settings highlighted](images/windows11-setup/lang-rightclick-start.png)

![Time & Language settings page](images/windows11-setup/lang-time-and-language.png)

![Add a language screen with English (United States) selected](images/windows11-setup/lang-add-english.png)

![Language features install screen with all options checked](images/windows11-setup/lang-install-features.png)
...
- [Windows 11 Initial Setup (PDF)](https://www2.iuj.ac.jp/mlic-cs/pdf/Win11_Initial%20setup.pdf)
- [Change language from Japanese to English (PDF)](https://www2.iuj.ac.jp/mlic-cs/pdf/Win11_Language_Change.pdf)
