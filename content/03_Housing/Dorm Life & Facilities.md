...
section: 03_Housing
tags: [housing, dorm, facilities, campus-life, daily-life]
...
- Air conditioning/heating is centrally controlled by campus — switched to heating in mid-October, back to cooling around mid-May
- Each room has a window with an AC unit on the outside; SD2 and SD3 rooms on higher floors can get significant snow accumulation around the window in winter — do not force the window open if it's blocked, contact Dorm Staff
...
CNP is the main student social and snack lounge, located near the dormitories. It was renovated in 2025–2026 with funding from a Cambodian IUJ alumnus.

What's there now:
- ~100-inch wall-mounted TV screen
- Wall-mounted speakers and ceiling spotlights
- Counter table with power outlets along the windows (café-style study/work space)
- IUJ logo wall (popular photo spot)
