...
Students on IUJ-provided scholarships are prioritized to move to SD4 first if SD1-3 overcrowds (can return to dorms if space becomes available, or stay off-campus). Older material named this as specifically "Nakayama Scholarship" students, but IUJ's own current materials only say "those on scholarships provided by IUJ" without naming a specific scholarship, so treat the specific name as unconfirmed.
